...
func TestAll(t *testing.T) {
	...
	for i := 0; i < length; i++ {
		...
		if !tree.Validate() {
			...
			outputJson(tree.Root, "testInsert.json")
			return
		}
	}
	...
	for key := range m {
		...
		if !tree.Validate() {
			...
			outputJson(tree.Root, "testDelete.json")
			return
		}
		i++
	}
...
func TestSpecific(t *testing.T) {
	...
	outputJson(tree.Root, "TestSpecific0001.json")
	tree.Delete(854)
	outputJson(tree.Root, "TestSpecific0002.json")
